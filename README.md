...
- "Pizza_sales_dataset.csv," contains information about pizzas, orders, and sales.
...
## Report Validation:
Report testing was done using SQL query to validate the data that were displayed in tableau and the values were displaying as expected.
